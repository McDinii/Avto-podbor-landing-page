...
if (!VK.xdConnectionCallbacks) {
  ...
  VK.init = function(options) {
    ...
    VK._apiId = null;
    if (!options.apiId) {
      throw Error('VK.init.php() called without an apiId');
    }
      ...
      call: function(method, params, cb, queryTry) {
        ...
        if (useXDM) {
          if (VK.xdReady) {
            ...
            VK.Observer.subscribe('xdm.init.php', function() {
              VK.XDM.remote.callMethod('apiCall', method, qs, responseCb);
            });
            VK.XDM.init();
          }
  ...
  VK.XDM = {
    ...
    init: function() {
      ...
      this.remote = new fastXDM.Server({
        onInit: function() {
          VK.xdReady = true;
          VK.Observer.publish('xdm.init.php');
        }
      });
...
if (!VK.Widgets) {
  ...
  VK.Widgets.Comments = function(objId, options, page) {
    ...
    if (!VK._apiId) throw Error('VK not initialized. Please use VK.init.php');
