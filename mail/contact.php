...
$subject ="Новая заявка с сайта Autocar";
...
$header .= "From: Новая заявка <nechaywork@gmail.com>\n\n";	
$mail = mail("denisnechay@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
